...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('banners', '0002_remove_banner_category_remove_banner_vendor_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner_type', models.CharField(choices=[('hero', 'Hero'), ('grid', 'Grid'), ('sidebar', 'Sidebar')], default='hero', help_text='Type of the banner (Hero, Grid, Sidebar)', max_length=10)),
                ('external_url', models.URLField(blank=True, help_text='Custom external URL for the banner', null=True)),
                ('position', models.CharField(choices=[('top', 'Top'), ('middle', 'Middle'), ('side', 'Side')], default='top', help_text='Position of the banner on the page', max_length=20)),
